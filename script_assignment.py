...
if os.path.exists('kwame_agyabeng'):
    try:
        shutil.rmtree('kwame_agyabeng')
        print(f"Directory '{'kwame_agyabeng'}' has been removed successfully.")
    except Exception as e:
        print(f"Error: {e}")

download_folder = 'kwame_agyabeng'
if not os.path.exists(download_folder):
    os.makedirs(download_folder)
    print(f"Directory: {download_folder} created.")

local_file_path = os.path.join(download_folder, "kwame_agyabeng.txt")
